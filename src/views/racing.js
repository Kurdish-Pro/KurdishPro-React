...
const Racing = () => {
  return (
    <div className={styles['container']}>
      <Helmet>
        <title>Racing - Kurdish_Pro</title>
        <meta property="og:title" content="Racing - Kurdish_Pro" />
      </Helmet>
      ...
      <div id="main-section" className={styles['Main']}>
        ...
        <div className={styles['Cards-container']}>
          ...
          >
            <span>
              .. Need For Speed Most Wanted 2005 Black Edition Free Download
            </span>
          </Link>
          <Link
            to="/n-f-s-h-eat"

...
const Simulation = () => {
  return (
    <div className={styles['container']}>
      <Helmet>
        <title>simulation - Kurdish_Pro</title>
        <meta property="og:title" content="simulation - Kurdish_Pro" />
      </Helmet>
      ...
      <div id="main-section" className={styles['Main']}>
        ...
        <div className={styles['Cards-container']}>
          ...
          >
            <span>.. Ranch Simulator Free Download</span>
          </Link>

...
const Home = () => {
  return (
    <div className={styles['container']}>
      <Helmet>
        <title>Kurdish_Pro</title>
        <meta property="og:title" content="Kurdish_Pro" />
      </Helmet>
      ...
      <div id="main-section" className={styles['Main']}>
        <h1 className={styles['text4']}>WELCOME</h1>
        <div className={styles['Cards-container']}>
          <Link to="/landing-page" className={styles['navlink6']}>
            <PlaceCard
              city="Gaming"
              image="/playground_assets/game-controller-joystick-joypad-gamepad-159204-1000h.jpeg"
              description=" "
          ...
          <div className={styles['container5']}>
            <PlaceCard
              city="Mobile"
              image="/playground_assets/photo-1546054454-aa26e2b734c7-1000h.jpg"
              description=" "
            ></PlaceCard>
            <PlaceCard
              city="Web Sites"
              image="/playground_assets/web-www-internet-blue-vector-icon-flat-design-illustration-eps-web-www-internet-blue-vector-icon-flat-design-199278330-1000w.jpg"
              description=" "
          ...
          <PlaceCard
            city="Pc Program"
            image="/playground_assets/robot-hand-artificial-intelligence-programming1-1000h.jpg"
            description=" "
          ></PlaceCard>
        </div>
      </div>

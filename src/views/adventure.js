...
const Adventure = () => {
  return (
    <div className={styles['container']}>
      <Helmet>
        <title>Adventure - Kurdish_Pro</title>
        <meta property="og:title" content="Adventure - Kurdish_Pro" />
      </Helmet>
      <div className={styles['Top-container']}>
        <nav className={styles['Navbar']}>
          ...
          <Link to="/" className={styles['navlink05']}>
      ...
      <div id="main-section" className={styles['Main']}>
        ...
        <div className={styles['Cards-container']}>
          ...
          <Link
            to="/life-i-s-strange-true-colors"
            className={` ${styles['navlink08']} ${projectStyles['thqLink']} `}
          >
            .. Life iIs Strange: True Colors
            <span
              dangerouslySetInnerHTML={{
                __html: ' ',
              }}

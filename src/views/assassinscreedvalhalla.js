...
import styles from './assassinscreedvalhalla.module.css'

const Assassinscreedvalhalla = () => {
  return (
    <div className={styles['container']}>
      <Helmet>
        <title>Assassin's creed valhalla - Kurdish_Pro</title>
        <meta
          property="og:title"
          content="Assassin's creed valhalla - Kurdish_Pro"
        />
      </Helmet>
      ...
      <div id="main-section" className={styles['Main']}>
        ...
        <div className={styles['Cards-container']}>
          <img
            alt="image"
            src="/playground_assets/assassins-creed-valhalla-1000h.jpg"
          ...
          <span className={styles['text23']}>
            ...
            <br></br>
            <span>.. Processor: I5-4460 3.2 GHz</span>
            <br></br>
            <span>.. memory: 8GB RAM</span>
            <br></br>
            <span>.. Graphics: Nvidia GeForce GTX 960</span>
            <br></br>
            <span>.. Storage: 50 GB available space</span>
          </span>
        </div>
        <a
          href="https://www.mediafire.com/file/mc9041fobb8fwno/assassins-creed-valhalla.torrent/file"
          target="_blank"
          rel="noreferrer noopener"
        ...
        <img
          alt="image"
          src="/playground_assets/assassinscreedvalhalla_3303783b-1000h.jpg"
          className={styles['image1']}
        />
        <h1 className={styles['text45']}>.</h1>
        <img
          alt="image"
          src="/playground_assets/assassinscreedvalhalla_3303723b-1200h.jpg"
